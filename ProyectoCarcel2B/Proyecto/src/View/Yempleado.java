...
public class Yempleado extends javax.swing.JPanel {
    private String mensaje;
    public Yempleado(String cedula) {
        initComponents();
    ...
    public void mostrarResultado(String cedula){
        ...
        if(sistema.eliminarEmp(cedula)){
            this.mensaje = "EMPLEADO ELIMINADO DELA BASE DE DATOS";
        }else
