...
public class FiltrarPPL extends javax.swing.JPanel {
    public FiltrarPPL() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INGRESA LA CEDULA DEL PPL:");
        ...
        cajita.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajitaActionPerformed(evt);
            }
        });
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        MostrarPPL panelMostrarEmp = new MostrarPPL(cedula);
        panelMostrarEmp.setSize(940, 450);
        panelMostrarEmp.setLocation(0, 0);
        
        inicial.removeAll();
        inicial.add(panelMostrarEmp, BorderLayout.CENTER);
        inicial.revalidate();
        inicial.repaint();
    }//GEN-LAST:event_jButton5ActionPerformed

    private void cajitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cajitaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cajitaActionPerformed
